...
interface ListTableProps {
  ...
  page?: number;
  limit?: number;
  ItemListComponent?: (_?: any, __?: any, ___?: any) => void;
  noHeader?: boolean;
  onItemClick?: (_: any) => void;
  onLoadSuccess?: (_: any) => void;
  onTdRow?: (_: any) => void;
  selectedItem?: any;
  needUpdate?: any;
...
const ListTable: React.FC<ListTableProps> = ({
  ...
  const getRows = async () => {
    try {
      setLoading(true);
      const _url = url.replace("{page}", __page).replace("{limit}", limit);
      const response = await apiClient.get(_url, { params });
