...
const TMTransferHistory = () => {
  const { isAuthenticated } = useTCWallet();
    ...
    <BodyContainer className={styles.wrapper}>
      <SectionContainer>
        <Text
          ...
          paddingX={[0, 0]}
        >
          TM is both the governance and utility token of Trustless Market. Early
          users who swap tokens or provide liquidity receive TM rewards. The more
