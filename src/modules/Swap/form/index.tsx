      ...
      openModal({
        ...
        render: () => (
          <Flex direction={'column'} gap={2}>
            ...
            />
            <Flex gap={1} alignItems={slippage === 100 ? 'center' : 'flex-start'}>
              <img
              ...
              <Text fontSize="sm" color="#B1B5C3" textAlign={'left'} maxW={"500px"}>
                {
                  slippage === 100 ? `Your current slippage is set at 100%. Trade at your own risk.` : `Your slippage percentage of ${slippage}% means that if the price changes by ${slippage}%, your transaction will fail and revert. If you wish to change your slippage percentage, please close this confirmation popup and go to the top of the swap box where you can set a different slippage value.`
                }
              </Text>
            </Flex>
            <FiledButton
