      ...
      <Box>
        ...
        <UnorderedList>
          <ListItem>
            ...
            and paste it here. Then click “Transfer”.
            <img
              alt="swap_step1_1"
              className={styles.introImg}
          ...
          <ListItem>
            Transfer your BTC to the following address. Your $BTC will be
        ...
        <UnorderedList>
          <ListItem>
            Put in the amount of ETH you want to wrap. Copy your TC address at{' '}
            <Link
              href={'https://trustlesswallet.io/'}
              target={'_blank'}
              style={{ textDecoration: 'underline' }}
  ...
  },
  {
    ...
    desc: (
      <Box>
          ...
          <ListItem>
            <Text>
              ...
              <Link
                ...
                style={{ textDecoration: 'underline' }}
              >
                https://newbitcoindex.com/launchpad
              </Link>{' '}
              and select the project you want to support
            </Text>
            <img
              alt="swap_step1_1"
              className={styles.introImg}
        ...
        <UnorderedList>
          <ListItem>
            Select the project with the “Voting” status. Then click “Support this
            Project”.
            <img
          ...
          <ListItem>
            Put in the amount of $TM you want to vote. If you don’t have $TM, you can
            earn 1 $TM for each time you add liquidity and 0.1 $TM for each swap on{' '}
            <Link
            ...
            <Link
              href={'https://discord.gg/HPuZHUexgv'}
              style={{ textDecoration: 'underline' }}
            >
              Discord channel
            </Link>{' '}
            for updates about potential $TM airdrops.
            <img
              alt="launchpad_step1_1"
              className={styles.introImg}
          ...
          <ListItem>
            ...
            , click “Process” your transaction on the transactions tab and wait for
            the confirmation on the mempool
          </ListItem>
        </UnorderedList>
        <Text>
          *Note:{' '}
          <Text fontWeight={'700'} as={'span'}>
            If a project is listed on the launchpad, voters will receive 5% of the
            project's total crowdfunding amount proportionally in project’s tokens.
          </Text>
        </Text>
        <Text fontWeight={'700'} mt={2}>
          4.2. Contributing
        ...
        <UnorderedList>
          <ListItem>Select the project with the “Funding” status.</ListItem>
          <ListItem>
            Put in the amount you want to contribute (in WETH or WBTC). Then click
            “Contribute to this project” {'=>'} Click “Confirm”
            <img
              alt="launchpad_step1_1"
              className={styles.introImg}
